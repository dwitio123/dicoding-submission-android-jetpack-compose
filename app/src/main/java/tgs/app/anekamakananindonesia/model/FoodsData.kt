package tgs.app.anekamakananindonesia.model
    ...
    val foods = listOf(
        ...
        Food(
            ...
            "- Kuning telur - 12 butir\n" +
                    ...
                    "- Terigu - 1 sdm\n" +
                    "- Air hangat - 50 ml",
            "1. Dalam wadah, campurkan semua bahan biang hingga rata. Diamkan selama 15 menit. Sisihkan.\n" +
        ...
        Food(
            ...
            "1. Campur rata ikan tenggiri halus dan air menggunakan tangan.\n" +
                    "2. Masukkan gula pasir, garam, dan penyedap rasa. Campur rata sampai adonan agak mengental. Masukkan tepung sagu ke dalam adonan. Campur perlahan menggunakan tangan, jangan diaduk terlalu keras.\n" +
                    "3. Bagi adonan menjadi masing-masing 150 gram untuk lenjer besar atau 25 gram untuk lenjer kecil. Bentuk seperti silinder.\n" +
                    "4. Rebus pempek dengan api sedang sampai mengapung dan permukaannya licin. Angkat dan tiriskan. Sajikan pempek dengan cuko.\n"
        ),
        Food(
            "Kerak Telor",
            ...
            "- 6 sdm beras ketan, rendam semalam dan tiriskan\n" +
                    ...
                    "- 2 sdm kelapa parut setengah tua, sangria\n" +
                    "- 1 sdm bawang goreng\n\n" +
                    "Bumbu lain\n" +
                    "- 1 sdm cabai merah iris, sangria dan haluskan\n" +
                    "- 1 sdt garam\n" +
                    "- 1 sdm cabai bubuk (opsional)",
            "1. Pertama, kocok telur bebek. Kemudian masukkan udang kering, bumbu yang dihaluskan, bawang goreng, dan kelapa sangrai. Aduk rata.\n" +
                    ...
                    "4. Hidangkan kerak telur selagi panas.\n" +
                    "5. Bila Sedulur menyukai kerak telur dengan cita rasa pedas, maka bisa menambahkan bubuk cabe di atas adonan kerak telur yang sudah matang.\n"
        ),
        Food(
            "Lumpia Basah",
            ...
            "Bahan kulit\n" +
                    ...
                    "- 1 butir telur seperempat sdt garam\n" +
                    "- 400 ml air\n\n" +
                    "Bumbu halus\n" +
                    "- 5 buah bawang putih\n" +
                    "- 1 sdt lada halus\n" +
                    ...
                    "- 1 buah tahu cina, iris dadu kecil, goreng\n" +
                    "- 100 gram taoge, buang ekornya\n" +
                    "- 1 buah wortel, serut, seduh dengan air panas\n" +
                    "- 1 batang daun bawang, rajang halus\n" +
                    "- 50 ml minyak goreng untuk menumis",
            "1. Campurkan tepung terigu, tepung tapioka, garam, aduk menjadi satu. Masukkan telur di tengah-tengah tepung, aduk dengan sendok atau balloon whisk. Tuang air sedikit demi sedikit hingga menjadi adonan cair.\n" +
                    "2. Siapkan teflon dan tuang adonan kulit lumpia basah. Sisihkan.\n" +
                    "3. Isi kulit lumpia basah: Panaskan minyak goreng, tumis bumbu halus hingga harum. Masukkan wortel dan bengkoang, aduk hingga layu.\n" +
                    "4. Masukkan taoge, tahu, dan daun bawang. Beri sedikit air bila perlu. Aduk hingga kering. Angkat dan taruh di piring.\n" +
                    "5. Ambil satu lembar kulit lumpia basah, beri sekitar satu sendok makan bahan isi, lipat seperti amplop. Lakukan hingga semua kulit lumpia habis. Sajikan lumpai basah bersama bawang lokio dan cabai rawit.\n"
        ),
        Food(
            "Rujak Cingur",
            ...
            "- Cingur - 250 gram\n" +
                    ...
                    "- Garam - seperempat sdt\n" +
                    "- Pisang klutuk atau batu, parut kasar - 2 buah\n" +
        ...
        Food(
            ...
            "- 2 butir kelapa, diambil santan kentalnya\n" +
                    ...
                    "- Secukupnya daun kelapa\n" +
                    "- Secukupnya garam",
            "1. Cuci beras ketan kemudian rendam di dalam air selama sekitar 2 jam\n" +
                    "2. Kukus beras ketan\n" +
                    "3. Sembari menunggu beras ketan matang, rebus santan kental sampai mendidih sambil terus diaduk-aduk biar santan tidak pecah. Tambahkan garam secukupnya biar makin gurih\n" +
                    "4. Jika beras ketan sudah matang, segera tuangkan santan kentalnya\n" +
                    "5. Bungkus dengan daun kelapa mudah dengan bentuk memanjang\n" +
                    "6. Ikat dengan benang hingga tertutup rapat\n" +
                    "7. Setelah itu, kukus lagi selama kurang lebih 1½ jam\n" +
                    "8. Angkat dan lapa-lapa sudah siap untuk dihidangkan\n"
        ),
        Food(
            "Karedok",
            ...
            R.drawable.karedok,
            "- Tauge, cuci bersih - 50 gram\n" +
                    "- Kacang panjang, cuci bersih dan iris kecil - 50 gram\n" +
                    "- Kol, cuci bersih dan iris halus - 50 gram\n" +
                    "- Daun kemangi, cuci bersih - 50 gram\n" +
                    "- Terong bulat hijau, cuci bersih dan iris tipis - 2 buah\n" +
                    "- Ketimun, cuci bersih dan iris kotak tipis - 1 buah\n\n" +
                    "BUMBU HALUS:\n" +
                    ...
                    "- Kencur - 4 cm\n" +
                    "- Terasi, bakar - setengah sdt\n" +
                    "- Air asam jawa - 2 sdm\n" +
                    "- Garam - 1 sdt\n" +
                    "- Air - 75 ml",
            "1. Dalam satu wadah besar, siapkan bumbu halus. Campur dengan air dan aduk hingga jadi pasta.\n" +
                    "2. Masukkan semua sayuran. Aduk hingga rata.\n" +
                    "3. Siap disajikan.\n"
        ),
        Food(
            "Papeda",
            ...
            "1. Rebus air sampai mendidih. Sementara siapkan sagu dibaskom atau piring mangkok dan diberi perasan jeruk, garam, dan air dingin secukupnya. Aduk sagu cair lalu disaring.\n" +
                    ...
                    "3. Papeda siap disajikan dengan sayuran dan lauk pauk.\n"
        ),
        Food(
            "Sate Padang",
            ...
            "DAGING:\n" +
                    ...
                    "LAINNYA:\n" +
                    "- Serai, memarkan lalu ikat jadi satu - 3 batang\n" +
                    "- Daun jeruk, sobek-sobek - 7 lembar\n" +
                    "- Daun kunyit, sobek-sobek - 1 lembar\n" +
                    "- Daun salam - 4 lembar\n" +
                    "- Tepung beras - 3 sdm\n" +
                    "- Asam kandis - 2 buah\n" +
            ...
            "1. Rebus semua bahan daging hingga daging setengah empuk dan tidak berdarah lagi. Angkat dan tiriskan daging lalu potong kotak-kotak sesuai selera. Sisihkan. Simpan air rebusan daging atau kaldu untuk membuat kuah. Sisihkan.\n" +
                    "2. Tumis bumbu halus hingga harum.\n" +
                    "3. Masukkan daun jeruk, daun kunyit, dan daun salam. Tumis kembali hingga benar-benar matang. Angkat dan bagi bumbu jadi 2 bagian.\n" +
                    "4. Ambil 1 bagian bumbu lalu campurkan dengan daging yang sudah dipotong-potong. Pindahkan dalam panci lalu tuang air secukupnya (hingga daging terendam). Masak atau ungkep daging hingga empuk dan bumbu meresap. Angkat.\n" +
                    "5. Ambil daging lalu tusukkan dan tata di tusukan sate. Lakukan hingga habis.\n" +
                    "6. Panggang sate sebentar saja di atas api atau wajan datar anti lengket atau teflon. Angkat.\n" +
                    "7. Kuah sate: Ambil 1 bagian bumbu sisanya lalu masak dengan air rebusan daging dan asam kandis hingga  mendidih.Masukkan tepung beras yang sudah dilarutkan dengan sedikit air. Aduk-aduk terus (agar tidak menggumpal) hingga kental dan meletup-letup. Koreksi rasanya. Angkat.\n" +
                    "8. Penyelesaian: Tata sate bersama lontong atau ketupat. Siram dengan kuah sate. Beri taburan bawang merah goreng.\n" +
                    "9. Siap disajikan."
        )
    )
}